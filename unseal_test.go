...
func TestConfigValidate(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "ok", cfg: Config{Nodes: []string{"https://127.0.0.1:8200"}, ProbeInterval: 5, KeySources: ks}},
		{name: "no nodes", cfg: Config{ProbeInterval: 5, KeySources: ks}, wantErr: true},
		{name: "zero interval", cfg: Config{Nodes: []string{"https://127.0.0.1:8200"}, KeySources: ks}, wantErr: true},
		{name: "negative interval", cfg: Config{Nodes: []string{"https://x"}, ProbeInterval: -1, KeySources: ks}, wantErr: true},
